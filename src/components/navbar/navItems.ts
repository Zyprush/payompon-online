import { IconChecklist, IconDeviceFloppy, IconHelpHexagon, IconInfoSquare, IconLayoutDashboard, IconNotification, IconPremiumRights, IconSettings, IconUserHexagon, IconUsers, IconVip } from "@tabler/icons-react";
