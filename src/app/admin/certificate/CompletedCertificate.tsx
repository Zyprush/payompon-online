...
const CompletedCertificate: React.FC = (): JSX.Element => {
  ...
  return (
      <div className="certificate-list">
        {loading ? (
          <p className="text-sm font-semibold flex items-center gap-3 text-zinc-600 border rounded-sm p-2 px-6 m-auto md:ml-0 md:mr-auto justify-center w-40">Loading...</p>
        ) : requests.length > 0 ? (
          ...
          <p className="text-sm font-semibold flex items-center gap-3 text-zinc-600 border rounded-sm p-2 px-6 m-auto md:ml-0 md:mr-auto justify-center w-80">No completed certificates found.</p>
        )}
      </div>
  );
};
