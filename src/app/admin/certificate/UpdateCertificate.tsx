      ...
      <div className="bg-white rounded-lg shadow-lg w-11/12 max-w-lg p-6">
        ...
        <div className="mb-4">
          ...
          >
            ...
            <option value="Financial Assistance Req.">Financial Assistance Req.</option>
            <option value="Securing Passport">Securing Passport</option>
            <option value="Livelihood Program Req.">Livelihood Program Req.</option>
            ...
            <option value="Travel Abroad Requirement">Travel Abroad Requirement</option>
            <option value="Medical Purposes">Medical Purposes</option>
            ...
            <option value="Appliance(s) Loan Req.">Appliance(s) Loan Req.</option>
            ...
            <option value="Retirement Requirement">Retirement Requirement</option>
            <option value="Tricycle Franchise Req.">Tricycle Franchise Req.</option>
            <option value="Business Registration">Business Registration</option>
            <option value="Bank Transaction">Bank Transaction</option>
            <option value="Securing Firearms License">Securing Firearms License</option>
            <option value="Whatever Legal Purposes">Whatever Legal Purposes</option>
